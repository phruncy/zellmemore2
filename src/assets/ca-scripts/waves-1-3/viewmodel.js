function ViewModel(automaton) 
{
  ...
  this._posY = [];
  this._segment = 0;
  this._radius = height/4;
  this.formerStates = [];

  this._movementPerFrame = 2;
  this._frames = 15;
  ...
  this.update = function(obj, args)
    {
        ...
        this.updateDefault();
        this._centerX += (mouseX - this._centerX)* 0.004;
        this._centerY += (mouseY - this._centerY)* 0.004;
        this._base += (mouseY - this._base)* 0.01;
        ...
        if (this.currentStatesArray[i] ===1)
          {
              ...
              this._posY.push(this._movementPerFrame * this._frames);
          }          
        else 
          {
