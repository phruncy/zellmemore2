...
@Component({
    ...
    template: ` <app-toolbar-toprow
            [(displayController)]="controllerDisplayed"></app-toolbar-toprow>
        <mat-divider></mat-divider>
        <app-automaton-controller
            class="controller"
            [class.active]="controllerDisplayed"></app-automaton-controller>`,
})
