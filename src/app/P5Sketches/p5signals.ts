...
export const signalFactory = (automaton: AutomatonService) => {
    ...
    return (p5: widgetP5) => {
        ...
        const initValues = () => {
            ...
            margin = p5.width * 0.1;
            gap = ((p5.width - 2 * margin) / automaton.cellnumber) * 0.2;
            dotSize = (p5.width - 2 * margin) / automaton.cellnumber - gap;
        ...
        const moveAgents = () => {
            const speed = 2 * amplitude * automaton.fps();
